...
import { UtilsService, SearchService, EntryService, KatoService } from '../../shared';
...
export class SearchComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public katoService: KatoService
  ) {}
  ...
  ngOnInit() {
    ...
    this.katoService.get().subscribe(response => this.katoes = response)
  }
  ...
  find() {
    ...
    const queryParam = this.createQueryParams();
  ...
  createQueryParams() {
    ...
    const queryParam = this.utils.createUrlParams(params);
    this.searchService.set('queryParam', queryParam);
    return queryParam;
  }

  getQueryParams() {
    const params = this.searchService.get('params');
    const queryParams = {};
